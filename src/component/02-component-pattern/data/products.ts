...
export const productOrdered3 = new ProductOrderdClass("3", "Ñoquis", "./coffee-mug.png", 980, ["Queso Rayado", "Salsa Bolognesa"],"disponible" )
export const productOrdered4 = new ProductOrderdClass("4", "Empanada", "./coffee-mug.png", 300, ["Aceituna"], "disponible" )

export const productsOrderedList: ProductOrderdClass[] = [
    // productOrdered1, productOrdered2,
